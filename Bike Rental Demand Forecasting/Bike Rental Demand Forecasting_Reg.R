...
#Decision Tree----
dt<-rpart(Rented_Bike_Count~Hour+Temperature+Humidity+Wind_speed+Visibility+Solar_Radiation+Rainfall+Snowfall+Seasons+Holiday, data=training, method = "anova")
...
svr <- svm(Rented_Bike_Count~Hour+Temperature+Humidity+Wind_speed+Visibility+Solar_Radiation+Rainfall+Snowfall+Seasons+Holiday, data = training, kernel = "radial")
